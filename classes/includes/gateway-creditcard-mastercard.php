...
final class WC_Payment_Gateway_Creditcard_Mastercard extends WC_Payment_Gateway
{
    public function __construct()
    {
        $this->id = PAYMENTGATEWAY_EXTENSION_UID_PREFIX . 'creditcard-mastercard';
        $this->method_title = PAYMENTGATEWAY_EXTENSION_NAME . ' CreditCard Mastercard';
        $this->method_description = 'Credit Card Mastercard transactions.';
        ...
        add_action('woocommerce_api_wc_payment_gateway_creditcard_mastercard', [$this, 'process_callback']);
    ...
    public function process_payment($orderId)
    {
        ...
        $callbackUrl = str_replace( 'https:', 'http:', add_query_arg( 'wc-api', 'WC_Payment_Gateway_Creditcard_Mastercard', home_url( '/' ) ) );
