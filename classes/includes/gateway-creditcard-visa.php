...
final class WC_Payment_Gateway_Creditcard_Visa extends WC_Payment_Gateway
{
    public function __construct()
    {
        $this->id = PAYMENTGATEWAY_EXTENSION_UID_PREFIX . 'creditcard-visa';
        $this->method_title = PAYMENTGATEWAY_EXTENSION_NAME . ' CreditCard Visa';
        $this->method_description = 'Credit Card Visa transactions.';
        ...
        add_action('woocommerce_api_wc_payment_gateway_creditcard_visa', [$this, 'process_callback']);
    ...
    public function process_payment($orderId)
    {
        ...
        $callbackUrl = str_replace( 'https:', 'http:', add_query_arg( 'wc-api', 'WC_Payment_Gateway_Creditcard_Visa', home_url( '/' ) ) );
